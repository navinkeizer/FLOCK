...
// Latest version: 11-11-2020
// This contract is strictly used to evaluate a proof of concept
...
// This contract contains the mechanism for starting an allocation
// Allocations of various sizes are allowed to be started and clients and sellers can join
// After all participants are collected, a node can become the worker node with TEE
contract Billboard{
...
// This oracle contract is only provided as an example and proof of concept
// We have not implemented any complex economic price derivation as it is out of our scope
// Instead, we simply use the change in number of nodes in the last allocation and the
// deviation of the USD/ETH price (through chainlink) to dictate the price.
contract Oracle{
    uint public price;
